  ...
  const playSong = useCallback(
    async (song: Song) => {
      ...
      try {
        ...
        try {
          const streamResponse = await fetch("/api/streaming/add", {
            method: "POST",
          ...
          if (!streamResponse.ok) {
            ...
            console.error("Failed to record play:", errorData.error);
          }
          ...
          console.error("API error when recording play:", apiError);
        }
      } catch (err) {
